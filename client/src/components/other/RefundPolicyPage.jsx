    ...
    <div className="bg-[#1D232A] text-[#A6ADBA] min-h-screen p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <section className="text-justify">
          <h2 className="text-3xl font-semibold">1. Overview</h2>
          <p className="mt-4 text-lg">
            At Course Bundler, we are committed to providing our customers with
        ...
        <section className="text-justify">
          <h2 className="text-3xl font-semibold">2. Refund Eligibility</h2>
          <p className="mt-4 text-lg">
        ...
        <section className="text-justify">
          <h2 className="text-3xl font-semibold">4. Refund Process</h2>
          <p className="mt-4 text-lg">
            To request a refund, please follow these steps:
          </p>
          <ul className="list-disc list-inside mt-4">
            <li>
              Contact our support team at support@coursebundler.com with your
        ...
        <section className="text-justify">
          <h2 className="text-3xl font-semibold">5. Partial Refunds</h2>
          <p className="mt-4 text-lg">
        ...
        <section className="text-justify">
          ...
          <p className="mt-4 text-lg">Email: support@coursebundler.com</p>
          <p className="mt-4 text-lg">
            Address: Course Bundler, 123 Tech Avenue, Silicon Valley, CA 94043
          </p>
        </section>
